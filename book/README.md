...
**2- [Enumeration](https://github.com/flast101/HTB-writeups/tree/master/book#2--enumeration)**   
...
What I dont like whith this solution is that it happens that there is no _**.ssh**_ directory with a ssh private key here. This solution won't work in such a case.
